...
var loadData = function(loc) {
  ...
  Papa.parse('https://raw.githubusercontent.com/MFikriFadhilah/Webmap_Kampa/main/data/LPHA_Kampa.csv', {
    header: true,
    download: true,
...
// styling, and event listener to layer_BatasKawasan
 var layer_BatasKawasan;
  ...
  layer_BatasKawasan = L.geoJson(json_BatasKawasanLPHA_Kampa,{
    attribution: '',
    interactive: true,
    dataVar: 'json_BatasKawasanLPHA_Kampa',
    layerName: 'layer_BatasKawasanLPHA_Kampa',
  ...
  map.attributionControl.setPrefix('Download <a href="'
    ...
    view <a href="https://github.com/MFikriFadhilah/Webmap_Kampa" target="_blank">code on\
